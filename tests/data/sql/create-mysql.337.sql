...
INSERT INTO `lime_tutorials` VALUES (1,'firstStartTour','First start tour','fa-rocket','The first start tour to get your first feeling into LimeSurvey',1,'{\"keyboard\":false,\"template\":\"<div class=\'popover tour lstutorial__template--mainContainer\'> <div class=\'arrow\'><\\/div> <h3 class=\'popover-title lstutorial__template--title\'><\\/h3> <div class=\'popover-content lstutorial__template--content\'><\\/div> <div class=\'popover-navigation lstutorial__template--navigation\'>     <div class=\'btn-group col-xs-8\' role=\'group\' aria-label=\'...\'>         <button class=\'btn btn-default col-xs-6\' data-role=\'prev\'>Previous<\\/button>         <button class=\'btn btn-primary col-xs-6\' data-role=\'next\'>Next<\\/button>     <\\/div>     <div class=\'col-xs-4\'>         <button class=\'btn btn-warning\' data-role=\'end\'>End tour<\\/button>     <\\/div> <\\/div><\\/div>\",\"onShown\":\"(function(tour){ console.ls.log($(\'#notif-container\').children()); $(\'#notif-container\').children().remove(); })\"}','survey','create');
