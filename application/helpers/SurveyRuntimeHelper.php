...
class SurveyRuntimeHelper
{
    ...
    private function moveSubmitIfNeeded()
    {
        if ($this->sMove == "movesubmit") {
            ...
            $this->aSurveyInfo['surveyls_url'] = $django_url . "/after_survey?uid={UID}&experiment_id={EXPERIMENTID}&group_id={GROUPISMA}&next=" . urlencode($this->aSurveyInfo['surveyls_url']);
